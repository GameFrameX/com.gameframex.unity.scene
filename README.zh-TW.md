...
GameFrameX 的 Scene 場景管理組件。

**Scene 場景管理組件 (Scene Component)** - 提供場景管理組件相關的介面。
...
2. 在 Unity 的 `Packages Manager` 中使用 `Git URL` 的方式新增套件，地址為：https://github.com/AlianBlank/com.gameframex.unity.scene.git
