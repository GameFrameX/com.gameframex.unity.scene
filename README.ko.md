...
GameFrameX의 Scene 씬 관리 컴포넌트.

**Scene 씬 관리 컴포넌트 (Scene Component)** - 씬 관리 컴포넌트 관련 인터페이스를 제공합니다.
...
2. Unity의 `Package Manager`에서 `Git URL`을 사용하여 추가: https://github.com/AlianBlank/com.gameframex.unity.scene.git
