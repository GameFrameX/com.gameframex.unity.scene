...
GameFrameX Scene Management Component.

**Scene Management Component (Scene Component)** - Provides interfaces related to scene management.
...
2. Add via Unity's `Package Manager` using `Git URL`: https://github.com/AlianBlank/com.gameframex.unity.scene.git
