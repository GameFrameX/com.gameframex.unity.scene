...
GameFrameX の Scene シーン管理コンポーネント。

**Scene シーン管理コンポーネント (Scene Component)** - シーン管理コンポーネント関連のインターフェースを提供します。
...
2. Unity の `Package Manager` で `Git URL` を使用して追加：https://github.com/AlianBlank/com.gameframex.unity.scene.git
